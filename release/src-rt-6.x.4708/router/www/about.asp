...
function onClick(){
	try { if (++clicks < 10){ moo(); }else{ clicks = 0; } }catch (ex) {}
}
...
<!-- VPN-BEGIN -->
VPN integration and GUI Copyright (C) 2010 Keith Moyer, <a href='mailto:tomatovpn@keithmoyer.com'>tomatovpn@keithmoyer.com</a><br><br>
<!-- VPN-END -->
...
<b>Thanks to everyone who risked their routers, tested, reported bugs, made suggestions and contributed to this project. ^ _ ^</b><br>
</div>
