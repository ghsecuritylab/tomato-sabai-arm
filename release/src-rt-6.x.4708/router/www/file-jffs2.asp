...
//	<% nvram("vpn_service,jffs2_on,jffs2_exec,t_fix1"); %>
...
<input type='hidden' name='_nextpage' value='file-jffs2.asp'>
...
<script type='text/javascript'>showNotice('<% notice("jffs"); %>');</script>
