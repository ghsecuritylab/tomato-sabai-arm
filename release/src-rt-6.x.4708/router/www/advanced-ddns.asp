...
//	<% nvram("vpn_service,ddnsx0,ddnsx1,ddnsx_ip,wan_dns,wan_get_dns,dns_addget,ddnsx_refresh,ddnsx_save"); %>
//	<% ddnsx(); %>
...
<input type='hidden' name='_nextpage' value='advanced-ddns.asp'>
