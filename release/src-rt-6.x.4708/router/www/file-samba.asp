...
//	<% nvram("vpn_service,smbd_enable,smbd_user,smbd_passwd,smbd_wgroup,smbd_cpage,smbd_custom,smbd_master,smbd_wins,smbd_shares,smbd_autoshare,wan_wins"); %>
...
<input type='hidden' name='_nextpage' value='file-samba.asp'>
