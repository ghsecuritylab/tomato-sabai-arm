...
//	<% nvram("vpn_service,ct_tcp_timeout,ct_udp_timeout,ct_timeout,ct_max,ct_hashsize,nf_l7in,nf_ttl,nf_sip,nf_rtsp,nf_pptp,nf_h323,nf_ftp"); %>
...
<input type='hidden' name='_nextpage' value='firewall-ctnf.asp'>
