...
<div class='title' id='SVPNstatus'><% sabaid(); %></div><div class='version' id='subversion'>version <% version(); %><!-- SABAI-VERSION --></div></td></tr>
<tr id='body'><td id='navi'><% sabaaiMenu(); %></td><td id='content'>

<!-- / / / -->

<!-- BEGIN REGISTRATION HTML -->
<div class='section-title'>Sabai Router Activation<span id='remacs' style='font-size: 12px;'></span></div>
...
createFieldTable('', [
 ...
 "<input id='programButton' value='Program' onclick='program();' type='button'>"
	...
	{ text: '<h3 style="display: inline">Activate Manually</h3> - Router is not connected to the internet or has been reset, enter your email address and click Activate Manually. Copy the code from the next page and email it to <a href="mailto:activation@sabaitechnology.com">activation@sabaitechnology.com</a>. Manual token retrieval is available during our normal business hours.<br><br><h3 style="display: inline">Program</h3> - Internal Sabai Technology use only',  hidden: pro.sabai },
