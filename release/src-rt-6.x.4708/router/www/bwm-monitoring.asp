...
//	<% nvram("vpn_service,rstats_enable,rstats_path,rstats_stime,rstats_offset,rstats_exclude,rstats_sshut,et0macaddr,cifs1,cifs2,jffs2_on,rstats_bak"); %>
...
<input type='hidden' name='_nextpage' value='bwm-monitoring.asp'>
