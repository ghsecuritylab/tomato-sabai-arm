...
<li><b>VPN</b> - Forward ports through the normal internet connection (WAN) or through the VPN tunnel, or both.  Note that when <a href='sabaivpn-dual.asp'>Dual Gateway</a> is active, only devices routed through a device, WAN ('local') OR VPN, will have ports forwarded through that device.  Additionally, ports will only be forwarded through the VPN when the VPN service is active.
